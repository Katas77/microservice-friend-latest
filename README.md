...
- Взаимодействие с другими сервисами производится с помощью технологии  Openfeign. Выбор данного REST-клиента основывался на его декларативности. То есть  ожидаемый объект сразу возвращается  Openfeign. 
